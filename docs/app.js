...
const classes = {
  "戰士": { hitDie: 10, hpBase: 10, proficiencies: ["所有護甲", "盾牌", "簡易武器", "軍用武器"], features: ["戰鬥風格", "回氣", "動作如潮", "額外攻擊", "不屈"], resources: ["回氣", "動作如潮", "不屈"], subclasses: ["門士", "血精英"], summary: "通用前排，擅長戰鬥風格與高行動效率。" },
  "野蠻人": { hitDie: 12, hpBase: 12, proficiencies: ["簡易武器", "軍用武器", "盾牌"], features: ["狂暴", "危險感知", "魯莽攻擊", "快速移動", "原始本能"], resources: ["狂暴次數"], subclasses: ["原初鬥士", "褻瀆者"], summary: "衝鋒型前線，以高生命值與狂暴爆發支撐戰場。" },
  "遊蕩者": { hitDie: 8, hpBase: 8, proficiencies: ["輕甲", "簡易武器", "手弩", "細劍"], features: ["偷襲", "巧手動作", "靈巧閃避", "可靠天賦", "心靈堅韌"], resources: ["偷襲傷害", "專精技能"], subclasses: ["詐術師", "刺客"], summary: "高機動與高技能職，擅長迂迴、隱匿與精準擊殺。" },
  ...
  "探索者": { hitDie: 10, hpBase: 10, proficiencies: ["輕甲", "中甲", "盾牌", "簡易武器", "軍用武器"], features: ["獵敵", "自然探索", "戰鬥風格", "原野祕法", "額外攻擊"], resources: ["獵敵目標", "法術位"], subclasses: ["馴獸師"], spellcasting: { ability: "wis", mode: "半施法", preparedFormula: "依等級與感知調整準備法術" }, summary: "偵察、追蹤與野外生存專家，兼具武技與祕法。" },
  "學者": { hitDie: 6, hpBase: 6, proficiencies: ["匕首", "標槍", "長棍", "輕弩", "書冊與工具"], features: ["知識骰", "學派研究", "奧術分析", "戰術指引", "廣泛學識"], resources: ["知識骰", "研究主題"], subclasses: ["特使", "工程師"], summary: "以知識支援戰局，適合情報、解謎與團隊增益。" },
...
const subclassSummaries = {
  ...
  "野蠻人:原初鬥士": ["偏向原始戰鬥本能與正面衝鋒。", "在地形與生存場景更有發揮。"],
  "野蠻人:褻瀆者": ["主打更兇猛的狂暴與禁忌力量。", "適合持續承受火力的前線。"],
...
const subclassAliases = {
  "戰士": { "血戰騎士": "血精英" },
  "野蠻人": { "荒魂行者": "原初鬥士", "血怒圖騰": "褻瀆者" },
  "遊蕩者": { "夜行密探": "詐術師", "靈刃客": "刺客" },
  "探索者": { "獸契行者": "馴獸師", "迷霧射手": "馴獸師" },
  "學者": { "遺物考證": "特使", "戰術史官": "工程師" },
